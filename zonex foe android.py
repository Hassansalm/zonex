...
if getattr(sys, 'frozen', False):
    # إذا كان التطبيق يعمل كمشغل APK
    BASE_DIR = os.path.dirname(sys.executable)
    FIREBASE_JSON_PATH = os.path.join(BASE_DIR, "assets", "firebase_key.json")
else:
    # إذا كان يعمل ككود Python عادي
...
if not firebase_admin._apps:
    ...
    firebase_admin.initialize_app(cred, {
        'storageBucket': 'hassan-df1ea.firebasestorage.app'  # استبدله برابط الـ Bucket الخاص بك من Firebase
    })
