...
def main(page: ft.Page):
    ...
    def add_new_data_row(e=None):
        fat_dd = ft.Dropdown(
            ...
            menu_width=100,
            expand=True,
            options=get_fat_options(),      # جلب الخيارات من fat 1 إلى fat 48
        )
    ...
    def route_change(e):
        ...
        if page.route == "/" or page.route == "/home":
            ...
            page.appbar = ft.AppBar(title="Zonex", center_title=True, bgcolor="#fafcff", title_text_style=ft.TextStyle(size=24, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_ACCENT))
            ...
            # صفحة الـ HOME العادية بداخل SafeArea لتجنب أي تداخل للحواف
            page.add(
                ft.SafeArea(
                    content=ft.Column([
